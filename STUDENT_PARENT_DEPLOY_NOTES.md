...
- `/student_parent/index.html`
- `/assets/beecoming-portal/logo.png`

上线后访问地址：

- `https://www.beecoming.com/student_parent`
...
2. 等网站自动发布完成后，打开 `https://www.beecoming.com/student_parent`。
3. 用飞书账号登录后，会回到 `https://www.beecoming.com/student_parent` 并读取绑定学生的课程和课外活动。
