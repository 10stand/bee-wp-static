...
!function (t) {
    ...
    var V, q, G, u, K, Z, h, Y, M, k, Q, o, J, $, l, s, c, f, P, tt, et, nt, ot, it, rt, I = [], at = !1, p = !1,
        lt = !1, d = [], st = !1, ct = !1, i = /\s+/g, dt = "Sortable" + (new Date).getTime(), ht = window,
        ut = ht.document, g = ht.parseInt, ft = ht.setTimeout, e = ht.jQuery || ht.Zepto, n = ht.Polymer,
        r = {capture: !1, passive: !1}, pt = !!navigator.userAgent.match(/(?:Trident.*rv[ :]?11\.|msie|iemobile)/i),
        ...
        a = "draggable" in ut.createElement("div"), b = function () {
            ...
            if (t.scroll) {
                ...
                var d = 0, h = Y;
                do {
                    var u, f, p, g, v, m, b, w, _, y = h, D = Mt(y), S = D.top, C = D.bottom, T = D.left, E = D.right,
                        x = D.width, N = D.height;
        ...
        if (t = t.touches ? t.touches[0] : t, V) {
            var e = function (t, e) {
                for (var n = 0; n < d.length; n++) if (!d[n].children.length) {
                    var o = Mt(d[n]), i = d[n][dt].options.emptyInsertThreshold,
                        r = t >= o.left - i && t <= o.right + i, a = e >= o.top - i && e <= o.bottom + i;
                    if (r && a) return d[n]
                }
            }(t.clientX, t.clientY);
    ...
    return X(ut, "dragover", t), X(ut, "mousemove", t), X(ut, "touchmove", t), _t.prototype = {
        constructor: _t, _computeIsAligned: function (t) {
            ...
            var e, n, o, i = this.el, r = t.target, a = this.options, l = a.group, s = _t.active, c = J === l,
                d = a.sort, h = this;
                ...
                if (r !== V && (lt = !1), s && !a.disabled && (c ? d || (o = !K.contains(V)) : $ === this || (this.lastPutMode = J.checkPull(this, s, V, t)) && l.checkPut(this, s, V, t))) {
                    ...
                    if (0 === i.children.length || i.children[0] === G || (O = t, B = u, H = Mt(Et(i)), R = "vertical" === B ? O.clientY : O.clientX, L = "vertical" === B ? O.clientX : O.clientY, W = "vertical" === B ? H.bottom : H.right, F = "vertical" === B ? H.left : H.top, z = "vertical" === B ? H.right : H.bottom, ("vertical" === B ? z + 10 < L || L <= z && W < R && F <= L : W < R && F < L || R <= W && z + 10 < L) && !V.animated)) {
                        ...
                        if (et !== r && (ot = null, f = Mt(r)["vertical" === u ? "top" : "left"], st = !1), E = r, x = u, N = (T = V) === V && rt || Mt(T), X = E === V && rt || Mt(E), Y = "vertical" === x ? N.left : N.top, M = "vertical" === x ? N.right : N.bottom, k = "vertical" === x ? N.width : N.height, P = "vertical" === x ? X.left : X.top, I = "vertical" === x ? X.right : X.bottom, A = "vertical" === x ? X.width : X.height, ot = (Y === P || M === I || Y + k / 2 === P + A / 2) && g || v || m || a.invertSwap || "insert" === ot || "swap" === ot ? ("swap" !== ot && (ct = a.invertSwap || v || at || m), p = function (t, e, n, o, i, r, a) {
                            var l = Mt(e), s = "vertical" === n ? t.clientY : t.clientX,
                                c = "vertical" === n ? l.height : l.width, d = "vertical" === n ? l.top : l.left,
                                h = "vertical" === n ? l.bottom : l.right, u = Mt(V), f = !1;
